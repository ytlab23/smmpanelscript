  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="font-semibold border-fuchsia-500 text-fuchsia-700 dark:text-fuchsia-300 hover:bg-fuchsia-50 dark:hover:bg-fuchsia-900/20 transition-colors duration-200">
          Become a Supporter
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Want to help keep SMMPanelScript free for everyone? Get in touch below!
          </DialogDescription>
        </DialogHeader>
        {submitted ? (
