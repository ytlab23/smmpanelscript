...
const detailFeatures = [/* ... unchanged ... */];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f8fafc] via-[#e0e7ff] to-[#f0fdfa] dark:from-[#0f172a] dark:via-[#1e293b] dark:to-[#0e172a] transition-colors duration-500">
      <Helmet>
        ...
        <meta name="description" content="Launch your own SMM panel for free with SMMPanelScript. No hidden fees, no coding required. Hosting included. Start your SMM business today!" />
      </Helmet>
