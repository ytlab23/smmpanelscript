...
const Terms = () => (
  <div className="max-w-2xl mx-auto py-16 px-4">
    <Helmet>
      ...
      <meta
        name="description"
        content="Read the Terms of Service for Free SMM Panel Script. Understand your rights and responsibilities when using our free SMM panel script and platform."
      />
    </Helmet>
