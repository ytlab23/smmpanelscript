...
const Terms = () => {
  useEffect(() => {
    document.title = "Terms Of Service | Free SMM Panel Script";
    const metaDesc = document.querySelector('meta[name="description"]');
    const descContent = "Read the Terms of Service for Free SMM Panel Script. Learn about our free SMM panel script, your responsibilities, and how we keep your panel running smoothly.";
    if (metaDesc) {
